...
- ⬜ Tailwind CSS + shadcn/ui kit in `src/components/ui`
- ⬜ App shell: responsive sidebar, top bar, breadcrumbs, dark mode
- ✅ Shared states: `LoadingState`, `EmptyState`, `ErrorState`, `SuccessMessage`, `ConfirmButton` (restyle on the kit)
...
- ⬜ Initial migration (`npm run db:migrate -- --name init`)
